## we will read the data from the csv file or from any database and split the data by performing the split test then data transformation will happen
import os
import sys 
